                        ...
                        <div class="content table-responsive table-full-width">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= ($value['permissions'] > 0 ? 'Activate' : 'Deactivated')?>
                                    </td>
                                    <td>
                                        <?php if($value['permissions'] == 0){?>
                                        <a href="./includes/form_submissions.php?id=<?= $value['id'];?>&permission=1" class="btn btn-success btn-xs">Activate</a>
                                        <?php }else{?>
                                        <a href="./includes/form_submissions.php?id=<?= $value['id'];?>&permission=0" class="btn btn-danger btn-xs">Deactivate</a>
                                        <?php }?>   
                                        |
                                        <a href="edit_admins.php?id=<?= $value['id'];?>" class="btn btn-default btn-xs">Edit</a>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
